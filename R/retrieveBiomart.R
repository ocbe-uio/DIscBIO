...
#' @description uses functions from the biomaRt package to retrieve dataframes
#'   from the BioMart Database
#' @details Since the BioMart database is not always accessible, this function
...
#' @param max_tries maximum number of times the function will try to reach the
#'   database
