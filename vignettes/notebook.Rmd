---
title: "DIscBIO: a user-friendly and reproducible pipeline for the discovery of scRNA-seq biomarkers"
...
![PSCAN](img/DiscBIO.png){width=75%}
...
```
    ...
    [32m✔[39m [34mpurrr  [39m 0.3.2       [32m✔[39m [34mforcats[39m 0.4.0  
    ...
    [31m✖[39m [34mhttr[39m::[32mcontent()[39m          masks [34mBiobase[39m::content()
    ...
    [31m✖[39m [34mpurrr[39m::[32mmap()[39m             masks [34mmclust[39m::map()
    ...
    [31m✖[39m [34mdplyr[39m::[32mselect()[39m          masks [34mbiomaRt[39m::select(), [34mMASS[39m::select()
    [31m✖[39m [34mpurrr[39m::[32msimplify()[39m        masks [34migraph[39m::simplify(), [34mDelayedArray[39m::simplify()
...
![DataPre-processing](img/Data-Preprocessing.png){width=75%}
...
![png](img/output_15_1.png){width=75%}
...
![PSCAN](img/Clustering.png){width=75%}
...
![png](img/output_21_1.png){width=75%}
...
![png](img/output_26_0.png){width=75%}
...
![png](img/output_27_1.png){width=75%}
...
![png](img/output_30_0.png){width=75%}
...
![png](img/output_31_0.png){width=75%}
...
![png](img/output_32_0.png){width=75%}
...
![png](img/output_35_1.png){width=75%}
...
![png](img/output_37_1.png){width=75%}
...
![png](img/output_40_1.png){width=75%}
...
![png](img/output_47_0.png){width=75%}
...
![png](img/output_48_0.png){width=75%}
...
![png](img/output_49_2.png){width=75%}



![png](img/output_49_3.png){width=75%}
...
![png](img/output_51_0.png){width=75%}
...
![png](img/output_52_1.png){width=75%}
...
![png](img/output_54_1.png){width=75%}
...
![png](img/output_57_0.png){width=75%}
...
![png](img/output_58_0.png){width=75%}
...
![png](img/output_60_1.png){width=75%}
...
![png](img/output_68_1.png){width=75%}
...
![png](img/output_71_1.png){width=75%}
...
![png](img/output_71_3.png){width=75%}
...
![png](img/output_71_5.png){width=75%}
...
![png](img/output_76_1.png){width=75%}
...
![Biomarkers](img/Networking.png){width=75%}
...
![png](img/output_83_2.png){width=75%}
...
![png](img/output_87_1.png){width=75%}
...
![png](img/output_94_1.png){width=75%}
...
![png](img/output_95_1.png){width=75%}
