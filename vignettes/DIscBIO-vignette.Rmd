...
```{r}
sc<- Clustexp(sc,cln=2,quiet=T)    #### K-means clustering to get three clusters
...
cdiff<-DEGanalysis2clust(sc,Clustering="K-means",K=2,fdr=0.05,name="Name",First="CL1",Second="CL2",export = TRUE,quiet=T)
```
...
```{r}
cdiff<-DEGanalysis(sc,Clustering="K-means",K=2,fdr=0.05,name="all_clusters",export = TRUE,quiet=T)   ####### differential expression analysis between all clusters
```
...
```{r}
cdiffBinomial<-KMClustDiffGenes(sc,K=2,fdr=.01,,quiet=T)    ########## Binomial differential expression analysis
#### To show the result table
...
MBcdiff<-DEGanalysis2clust(sc,Clustering="MB",K=3,fdr=0.1,name="Name",First="CL1",Second="CL2",export = TRUE,quiet=F)   
#### To show the result table
