...
![DIsccBIO](MB1.png){width=80%}

Model-based clustering assumes that the data are generated by a model and attempts to recover the original model from the data to define cellular clusters. The steps reproduced here are comparable to the ones on Section [2.1](#21-k-means-clustering), and the output will be suppressed for brevity.
